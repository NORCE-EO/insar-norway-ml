...
<section id="data-preprocessing">
    <h2 class="section-title">Data Preprocessing</h2>
    <div class="card-grid">
        <div class="card" onclick="window.location.href='{{ '/data-preprocessing/ambiguity-correction/' | relative_url }}'">
            <h3>Ambiguity Correction</h3>
            <p>Techniques for addressing phase ambiguity in InSAR measurements.</p>
        ...
        <div class="card" onclick="window.location.href='{{ '/data-preprocessing/data-imputation/' | relative_url }}'">
            <h3>Data Imputation</h3>
            <p>Methods for handling missing data and filling gaps in time series.</p>
            <span class="card-link">Explore Method <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg></span>
        </div>
    </div>
</section>
